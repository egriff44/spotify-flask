...
if __name__ == '__main__':
    ...
    # genres = {1: 2, 3: 4, 4: 3, 2: 1, 0: 0}
    # dict(sorted(genres.items(), key=lambda item: item[1]))
    # for key in  dict(sorted(genres.items(), key=lambda item: item[1])).keys():
    #     print(key)
    # print(key for key in genres.keys())